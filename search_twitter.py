...
def search_by_hashtags(hash_tag_search):
  ...
  url = 'http://twitter.casdfom/phoenix_search.phoenix?q={hash_tag_search}&include_entities=1&include_available_features=1&contributor_details=true&filter=links'.format(hash_tag_search=hash_tag_search)
  try:
    r = urllib2.Request(url, '', { 'User-Agent' : "Mozilla/5.0 (X11; U; Linux i686) Gecko/20071127 Firefox/2.0.0.11" })
